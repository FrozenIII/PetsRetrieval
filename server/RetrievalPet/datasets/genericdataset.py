...
from RetrievalPet.datasets.datahelpers import default_loader, imresize
...
class ImagesFromList(data.Dataset):
    ...
    def __init__(self, root, images, imsize=None, re_size=True, bbxs=None, transform=None, loader=default_loader, isbase64=False):
        if not isbase64:
